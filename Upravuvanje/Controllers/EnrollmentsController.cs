...
namespace Upravuvanje.Controllers
{
    public class EnrollmentsController : Controller
    {
        ...
        public EnrollmentsController(UpravuvanjeContext context)
        {
            _context = context;
        }
        ...
        {
            var upravuvanjeContext = _context.Enrollment.Include(e => e.Course).Include(e => e.Student);
        ...
        public async Task<IActionResult> Create([Bind("Id,Semestar,Year,Grade,SeminalUrl,ProjectUrl,ExamPoint,SeminalPoints,ProjectPoints,AdditionalPoints,FinishDate,StudentId,CourseId")] Enrollment enrollment)
        {
